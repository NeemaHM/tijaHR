...
export default function TijaHRLandingPro() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", color: "var(--text)", background: "var(--bg)" }}>
      ...
      {/* Demo form */}
      <section id="demo" style={{ background: "var(--surface)", padding: "72px 24px", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 620, margin: "0 auto" }}>
          ...
          {submitted ? (
            <div className="reveal is-visible" role="status" style={{ background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 12, padding: 32, textAlign: "center" }}>
            ...
            <form onSubmit={handleSubmit} noValidate className="reveal" style={{ background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 12, padding: 28, display: "flex", flexDirection: "column", gap: 14 }}>
